...
def main() -> int:
    ...
    parser.add_argument("--metrics_dir", default="/data/efficient-mcts/metrics")
    ...
    for key in ["total_frames", "log_interval", "evaluate_episodes", "num_envs"]:
    ...
    metrics_path = Path(args.metrics_dir) / exp_name / f"{run_name}.jsonl"
